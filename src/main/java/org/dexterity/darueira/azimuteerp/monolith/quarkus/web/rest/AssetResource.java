...
/**
 * REST controller for managing {@link org.dexterity.darueira.azimuteerp.monolith.quarkus.domain.Asset}.
 */
@Path("/api/assets")
...
public class AssetResource {
    ...
    public Response getAllAssets(
        ...
        Paged<AssetDTO> result;
        if (eagerload) {
            result = assetService.findAllWithEagerRelationships(page);
        } else {
            result = assetService.findAll(page);
        }
