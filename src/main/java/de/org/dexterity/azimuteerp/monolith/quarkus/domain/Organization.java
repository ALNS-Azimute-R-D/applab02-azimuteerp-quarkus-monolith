...
public class Organization extends PanacheEntityBase implements Serializable {
    ...
    public static Organization update(Organization organization) {
        ...
        if (entity != null) {
            ...
            entity.mainContactPersonDetails = organization.mainContactPersonDetails;
            entity.technicalEnvironmentsDetails = organization.technicalEnvironmentsDetails;
            entity.commonCustomAttributesDetails = organization.commonCustomAttributesDetails;
