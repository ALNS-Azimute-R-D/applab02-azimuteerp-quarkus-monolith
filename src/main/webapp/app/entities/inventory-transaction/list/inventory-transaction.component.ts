...
import { EntityArrayResponseType, InventoryTransactionService } from '../service/inventory-transaction.service';
...
export class InventoryTransactionComponent implements OnInit {
  ...
  trackId = (_index: number, item: IInventoryTransaction): number =>
    this.inventoryTransactionService.getInventoryTransactionIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.inventoryTransactions = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IInventoryTransaction[] | null): IInventoryTransaction[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.inventoryTransactionService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
