...
import { sampleWithRequiredData } from '../inventory-transaction.test-samples';
...
describe('InventoryTransaction Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'inventory-transaction', component: InventoryTransactionComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to inventoryTransactionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getInventoryTransactionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getInventoryTransactionIdentifier).toHaveBeenCalledWith(entity);
