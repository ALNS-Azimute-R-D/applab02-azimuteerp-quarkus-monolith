...
const requireRestSample: RestInventoryTransaction = {
  ...sampleWithRequiredData,
  transactionCreatedDate: sampleWithRequiredData.transactionCreatedDate?.toJSON(),
  transactionModifiedDate: sampleWithRequiredData.transactionModifiedDate?.toJSON(),
};
