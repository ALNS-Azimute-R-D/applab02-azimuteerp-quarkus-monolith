...
type RestOf<T extends IInventoryTransaction | NewInventoryTransaction> = Omit<T, 'transactionCreatedDate' | 'transactionModifiedDate'> & {
...
export class InventoryTransactionService {
  ...
  protected convertDateFromClient<T extends IInventoryTransaction | NewInventoryTransaction | PartialUpdateInventoryTransaction>(
    ...
    return {
      ...
      transactionCreatedDate: inventoryTransaction.transactionCreatedDate?.toJSON() ?? null,
      transactionModifiedDate: inventoryTransaction.transactionModifiedDate?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restInventoryTransaction: RestInventoryTransaction): IInventoryTransaction {
    return {
      ...
      transactionCreatedDate: restInventoryTransaction.transactionCreatedDate
        ? dayjs(restInventoryTransaction.transactionCreatedDate)
        : undefined,
      transactionModifiedDate: restInventoryTransaction.transactionModifiedDate
        ? dayjs(restInventoryTransaction.transactionModifiedDate)
        : undefined,
    };
  }
