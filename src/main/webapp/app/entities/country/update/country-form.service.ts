...
type CountryFormGroupContent = {
  ...
  acronym: FormControl<ICountry['acronym']>;
  name: FormControl<ICountry['name']>;
  continent: FormControl<ICountry['continent']>;
  geoPolygonArea: FormControl<ICountry['geoPolygonArea']>;
  geoPolygonAreaContentType: FormControl<ICountry['geoPolygonAreaContentType']>;
};
...
export class CountryFormService {
  createCountryFormGroup(country: CountryFormGroupInput = { id: null }): CountryFormGroup {
    ...
    return new FormGroup<CountryFormGroupContent>({
      ...
      acronym: new FormControl(countryRawValue.acronym, {
        validators: [Validators.required, Validators.maxLength(3)],
      }),
      name: new FormControl(countryRawValue.name, {
        validators: [Validators.required, Validators.maxLength(40)],
      }),
      continent: new FormControl(countryRawValue.continent, {
        validators: [Validators.required],
      }),
      geoPolygonArea: new FormControl(countryRawValue.geoPolygonArea),
      geoPolygonAreaContentType: new FormControl(countryRawValue.geoPolygonAreaContentType),
    });
  }
