...
import { EntityArrayResponseType, AssetTypeService } from '../service/asset-type.service';
...
export class AssetTypeComponent implements OnInit {
  ...
  trackId = (_index: number, item: IAssetType): number => this.assetTypeService.getAssetTypeIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.assetTypes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IAssetType[] | null): IAssetType[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.assetTypeService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
