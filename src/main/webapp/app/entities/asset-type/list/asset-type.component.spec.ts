...
import { sampleWithRequiredData } from '../asset-type.test-samples';
...
describe('AssetType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'asset-type', component: AssetTypeComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to assetTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAssetTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAssetTypeIdentifier).toHaveBeenCalledWith(entity);
