...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../asset-type.test-samples';

import { AssetTypeService } from './asset-type.service';

const requireRestSample: IAssetType = {
...
describe('AssetType Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a AssetType', () => {
      const assetType = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(assetType).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a AssetType', () => {
      const assetType = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(assetType).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addAssetTypeToCollectionIfMissing', () => {
      it('should add a AssetType to an empty array', () => {
        const assetType: IAssetType = sampleWithRequiredData;
      ...
      it("should add a AssetType to an array that doesn't contain it", () => {
        const assetType: IAssetType = sampleWithRequiredData;
        const assetTypeCollection: IAssetType[] = [sampleWithPartialData];
        expectedResult = service.addAssetTypeToCollectionIfMissing(assetTypeCollection, assetType);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(assetType);
      });
      ...
      it('should add only unique AssetType to an array', () => {
        const assetTypeArray: IAssetType[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const assetTypeCollection: IAssetType[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const assetType: IAssetType = sampleWithRequiredData;
        const assetType2: IAssetType = sampleWithPartialData;
    ...
    describe('compareAssetType', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareAssetType(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareAssetType(entity1, entity2);
        const compareResult2 = service.compareAssetType(entity2, entity1);
