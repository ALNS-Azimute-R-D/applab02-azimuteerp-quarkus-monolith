...
import { sampleWithRequiredData } from '../organization-role.test-samples';
...
describe('OrganizationRole Management Component', () => {
  let comp: OrganizationRoleComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'organization-role', component: OrganizationRoleComponent }]),
      ...
      .overrideTemplate(OrganizationRoleComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to organizationRoleService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOrganizationRoleIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOrganizationRoleIdentifier).toHaveBeenCalledWith(entity);
