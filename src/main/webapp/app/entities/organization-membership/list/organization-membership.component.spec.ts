...
import { sampleWithRequiredData } from '../organization-membership.test-samples';
...
describe('OrganizationMembership Management Component', () => {
  let comp: OrganizationMembershipComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'organization-membership', component: OrganizationMembershipComponent }]),
      ...
      .overrideTemplate(OrganizationMembershipComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to organizationMembershipService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOrganizationMembershipIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOrganizationMembershipIdentifier).toHaveBeenCalledWith(entity);
