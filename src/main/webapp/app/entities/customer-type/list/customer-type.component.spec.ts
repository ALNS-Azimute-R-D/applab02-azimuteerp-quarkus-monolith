...
import { sampleWithRequiredData } from '../customer-type.test-samples';
...
describe('CustomerType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'customer-type', component: CustomerTypeComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to customerTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCustomerTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCustomerTypeIdentifier).toHaveBeenCalledWith(entity);
