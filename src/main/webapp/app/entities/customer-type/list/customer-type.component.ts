...
import { EntityArrayResponseType, CustomerTypeService } from '../service/customer-type.service';
...
export class CustomerTypeComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICustomerType): number => this.customerTypeService.getCustomerTypeIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.customerTypes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ICustomerType[] | null): ICustomerType[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.customerTypeService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
