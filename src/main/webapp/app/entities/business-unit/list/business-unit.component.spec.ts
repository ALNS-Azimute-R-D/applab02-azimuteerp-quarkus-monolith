...
import { sampleWithRequiredData } from '../business-unit.test-samples';
...
describe('BusinessUnit Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'business-unit', component: BusinessUnitComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to businessUnitService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getBusinessUnitIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBusinessUnitIdentifier).toHaveBeenCalledWith(entity);
