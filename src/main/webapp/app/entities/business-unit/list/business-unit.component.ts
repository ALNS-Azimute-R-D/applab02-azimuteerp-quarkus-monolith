...
import { EntityArrayResponseType, BusinessUnitService } from '../service/business-unit.service';
...
export class BusinessUnitComponent implements OnInit {
  ...
  trackId = (_index: number, item: IBusinessUnit): number => this.businessUnitService.getBusinessUnitIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.businessUnits = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IBusinessUnit[] | null): IBusinessUnit[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.businessUnitService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
