...
@Component({
  standalone: true,
  templateUrl: './organization-member-role-delete-dialog.component.html',
  imports: [SharedModule, FormsModule],
})
export class OrganizationMemberRoleDeleteDialogComponent {
  ...
  confirmDelete(id: number): void {
    this.organizationMemberRoleService.delete(id).subscribe(() => {
