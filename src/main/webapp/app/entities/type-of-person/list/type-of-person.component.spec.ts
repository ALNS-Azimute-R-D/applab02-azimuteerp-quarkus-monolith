...
import { sampleWithRequiredData } from '../type-of-person.test-samples';
import { TypeOfPersonService } from '../service/type-of-person.service';

import { TypeOfPersonComponent } from './type-of-person.component';
import SpyInstance = jest.SpyInstance;

describe('TypeOfPerson Management Component', () => {
  let comp: TypeOfPersonComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'type-of-person', component: TypeOfPersonComponent }]),
      ...
      .overrideTemplate(TypeOfPersonComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to typeOfPersonService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTypeOfPersonIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTypeOfPersonIdentifier).toHaveBeenCalledWith(entity);
