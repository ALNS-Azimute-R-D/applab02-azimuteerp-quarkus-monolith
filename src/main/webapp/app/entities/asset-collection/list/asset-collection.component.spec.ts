...
import { sampleWithRequiredData } from '../asset-collection.test-samples';
...
describe('AssetCollection Management Component', () => {
  let comp: AssetCollectionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'asset-collection', component: AssetCollectionComponent }]),
      ...
      .overrideTemplate(AssetCollectionComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to assetCollectionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAssetCollectionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAssetCollectionIdentifier).toHaveBeenCalledWith(entity);
