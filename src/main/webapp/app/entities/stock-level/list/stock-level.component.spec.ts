...
import { sampleWithRequiredData } from '../stock-level.test-samples';
...
describe('StockLevel Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'stock-level', component: StockLevelComponent }]),
      ...
      .overrideTemplate(StockLevelComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to stockLevelService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getStockLevelIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getStockLevelIdentifier).toHaveBeenCalledWith(entity);
