...
public class WarehouseResourceTest {
    ...
    public static WarehouseDTO createEntity() {
        ...
        warehouseDTO.customAttributesDetailsJSON = DEFAULT_CUSTOM_ATTRIBUTES_DETAILS_JSON;
        warehouseDTO.activationStatus = DEFAULT_ACTIVATION_STATUS;
        return warehouseDTO;
    }
    ...
    public void createWarehouse() {
        ...
        assertThat(testWarehouseDTO.customAttributesDetailsJSON).isEqualTo(DEFAULT_CUSTOM_ATTRIBUTES_DETAILS_JSON);
        assertThat(testWarehouseDTO.activationStatus).isEqualTo(DEFAULT_ACTIVATION_STATUS);
    }
    ...
    public void checkActivationStatusIsRequired() throws Exception {
        ...
        // set the field null
        warehouseDTO.activationStatus = null;
    ...
    public void updateWarehouse() {
        ...
        updatedWarehouseDTO.customAttributesDetailsJSON = UPDATED_CUSTOM_ATTRIBUTES_DETAILS_JSON;
        updatedWarehouseDTO.activationStatus = UPDATED_ACTIVATION_STATUS;
        ...
        assertThat(testWarehouseDTO.customAttributesDetailsJSON).isEqualTo(UPDATED_CUSTOM_ATTRIBUTES_DETAILS_JSON);
        assertThat(testWarehouseDTO.activationStatus).isEqualTo(UPDATED_ACTIVATION_STATUS);
    }
