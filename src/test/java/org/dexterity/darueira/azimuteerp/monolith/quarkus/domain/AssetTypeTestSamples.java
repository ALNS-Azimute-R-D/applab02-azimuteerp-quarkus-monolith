...
public class AssetTypeTestSamples {
    ...
    public static AssetType getAssetTypeSample1() {
        ...
        assetType.customAttributesDetailsJSON = "customAttributesDetailsJSON1";
        return assetType;
    }
    ...
    public static AssetType getAssetTypeSample2() {
        ...
        assetType.customAttributesDetailsJSON = "customAttributesDetailsJSON2";
        return assetType;
    }
    ...
    public static AssetType getAssetTypeRandomSampleGenerator() {
        ...
        assetType.customAttributesDetailsJSON = UUID.randomUUID().toString();
        return assetType;
    }
}
