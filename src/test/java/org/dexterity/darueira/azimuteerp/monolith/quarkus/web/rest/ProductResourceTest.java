...
public class ProductResourceTest {
    ...
    public static ProductDTO createEntity() {
        ...
        productDTO.activationStatus = DEFAULT_ACTIVATION_STATUS;
        return productDTO;
    }
    ...
    public void createProduct() {
        ...
        assertThat(testProductDTO.activationStatus).isEqualTo(DEFAULT_ACTIVATION_STATUS);
    }
    ...
    public void checkActivationStatusIsRequired() throws Exception {
        ...
        // set the field null
        productDTO.activationStatus = null;
    ...
    public void updateProduct() {
        ...
        updatedProductDTO.activationStatus = UPDATED_ACTIVATION_STATUS;
        ...
        assertThat(testProductDTO.activationStatus).isEqualTo(UPDATED_ACTIVATION_STATUS);
    }
