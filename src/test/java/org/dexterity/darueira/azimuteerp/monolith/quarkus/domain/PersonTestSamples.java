...
public class PersonTestSamples {
    ...
    public static Person getPersonSample1() {
        ...
        person.customAttributesDetailsJSON = "customAttributesDetailsJSON1";
        return person;
    }
    ...
    public static Person getPersonSample2() {
        ...
        person.customAttributesDetailsJSON = "customAttributesDetailsJSON2";
        return person;
    }
    ...
    public static Person getPersonRandomSampleGenerator() {
        ...
        person.fullname = UUID.randomUUID().toString();
        ...
        person.customAttributesDetailsJSON = UUID.randomUUID().toString();
        return person;
    }
}
