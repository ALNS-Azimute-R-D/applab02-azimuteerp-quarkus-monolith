...
public class StockLevelAsserts {
    ...
    public static void assertStockLevelUpdatableFieldsEquals(StockLevel expected, StockLevel actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.remainingQuantity).as("check remainingQuantity").isEqualTo(actual.remainingQuantity))
            .satisfies(
                e ->
                    assertThat(e.commonAttributesDetailsJSON)
                        .as("check commonAttributesDetailsJSON")
                        .isEqualTo(actual.commonAttributesDetailsJSON)
            );
    }
