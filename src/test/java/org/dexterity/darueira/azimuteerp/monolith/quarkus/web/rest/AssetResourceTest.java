...
public class AssetResourceTest {
    ...
    public static AssetDTO createEntity() {
        ...
        assetDTO.activationStatus = DEFAULT_ACTIVATION_STATUS;
        return assetDTO;
    }
    ...
    public void createAsset() {
        ...
        assertThat(testAssetDTO.activationStatus).isEqualTo(DEFAULT_ACTIVATION_STATUS);
    }
    ...
    public void checkActivationStatusIsRequired() throws Exception {
        ...
        // set the field null
        assetDTO.activationStatus = null;
    ...
    public void updateAsset() {
        ...
        updatedAssetDTO.activationStatus = UPDATED_ACTIVATION_STATUS;
        ...
        assertThat(testAssetDTO.activationStatus).isEqualTo(UPDATED_ACTIVATION_STATUS);
    }
