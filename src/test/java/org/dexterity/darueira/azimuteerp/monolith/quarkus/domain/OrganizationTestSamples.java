...
public class OrganizationTestSamples {
    ...
    public static Organization getOrganizationSample1() {
        ...
        organization.mainContactPersonDetailsJSON = "mainContactPersonDetailsJSON1";
        organization.technicalEnvironmentsDetailsJSON = "technicalEnvironmentsDetailsJSON1";
        organization.customAttributesDetailsJSON = "customAttributesDetailsJSON1";
        return organization;
    }
    ...
    public static Organization getOrganizationSample2() {
        ...
        organization.mainContactPersonDetailsJSON = "mainContactPersonDetailsJSON2";
        organization.technicalEnvironmentsDetailsJSON = "technicalEnvironmentsDetailsJSON2";
        organization.customAttributesDetailsJSON = "customAttributesDetailsJSON2";
        return organization;
    }
    ...
    public static Organization getOrganizationRandomSampleGenerator() {
        ...
        organization.mainContactPersonDetailsJSON = UUID.randomUUID().toString();
        organization.technicalEnvironmentsDetailsJSON = UUID.randomUUID().toString();
        organization.customAttributesDetailsJSON = UUID.randomUUID().toString();
        return organization;
    }
}
