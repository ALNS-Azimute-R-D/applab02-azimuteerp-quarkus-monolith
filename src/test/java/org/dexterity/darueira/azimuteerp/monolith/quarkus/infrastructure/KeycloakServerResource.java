package org.dexterity.darueira.azimuteerp.monolith.quarkus.infrastructure;
...
public class KeycloakServerResource implements QuarkusTestResourceLifecycleManager, DevServicesContext.ContextAware {
    ...
    public Map<String, String> start() {
        container = new KeycloakContainer("quay.io/keycloak/keycloak:24.0.1").withRealmImportFile("jhipster-realm.json");
