...
public class WarehouseTestSamples {
    ...
    public static Warehouse getWarehouseSample1() {
        ...
        warehouse.description = "description1";
        ...
        warehouse.customAttributesDetailsJSON = "customAttributesDetailsJSON1";
        return warehouse;
    }
    ...
    public static Warehouse getWarehouseSample2() {
        ...
        warehouse.description = "description2";
        ...
        warehouse.customAttributesDetailsJSON = "customAttributesDetailsJSON2";
        return warehouse;
    }
    ...
    public static Warehouse getWarehouseRandomSampleGenerator() {
        ...
        warehouse.description = UUID.randomUUID().toString();
        ...
        warehouse.customAttributesDetailsJSON = UUID.randomUUID().toString();
        return warehouse;
    }
}
