...
public class InvoiceResourceTest {
    ...
    public static InvoiceDTO createEntity() {
        ...
        invoiceDTO.originalOrderId = DEFAULT_ORIGINAL_ORDER_ID;
        ...
        invoiceDTO.extraDetails = DEFAULT_EXTRA_DETAILS;
        return invoiceDTO;
    }
    ...
    public void createInvoice() {
        ...
        assertThat(testInvoiceDTO.originalOrderId).isEqualTo(DEFAULT_ORIGINAL_ORDER_ID);
        ...
        assertThat(testInvoiceDTO.extraDetails).isEqualTo(DEFAULT_EXTRA_DETAILS);
    }
    ...
    public void updateInvoice() {
        ...
        updatedInvoiceDTO.originalOrderId = UPDATED_ORIGINAL_ORDER_ID;
        ...
        updatedInvoiceDTO.extraDetails = UPDATED_EXTRA_DETAILS;
        ...
        assertThat(testInvoiceDTO.originalOrderId).isEqualTo(UPDATED_ORIGINAL_ORDER_ID);
        ...
        assertThat(testInvoiceDTO.extraDetails).isEqualTo(UPDATED_EXTRA_DETAILS);
    }
    ...
    public void getAllInvoices() {
        ...
        given()
            ...
            .body("originalOrderId", hasItem(DEFAULT_ORIGINAL_ORDER_ID.intValue()))
    ...
    public void getInvoice() {
        ...
        given()
            ...
            .body("originalOrderId", is(DEFAULT_ORIGINAL_ORDER_ID.intValue()))
