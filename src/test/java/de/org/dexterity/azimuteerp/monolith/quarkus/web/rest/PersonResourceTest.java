...
public class PersonResourceTest {
    ...
    public static PersonDTO createEntity() {
        ...
        personDTO.firstName = DEFAULT_FIRST_NAME;
        personDTO.lastName = DEFAULT_LAST_NAME;
        ...
        personDTO.extraDetails = DEFAULT_EXTRA_DETAILS;
    ...
    public void createPerson() {
        ...
        assertThat(testPersonDTO.firstName).isEqualTo(DEFAULT_FIRST_NAME);
        assertThat(testPersonDTO.lastName).isEqualTo(DEFAULT_LAST_NAME);
        ...
        assertThat(testPersonDTO.extraDetails).isEqualTo(DEFAULT_EXTRA_DETAILS);
    ...
    public void updatePerson() {
        ...
        // Update the person
        updatedPersonDTO.firstName = UPDATED_FIRST_NAME;
        updatedPersonDTO.lastName = UPDATED_LAST_NAME;
        ...
        updatedPersonDTO.extraDetails = UPDATED_EXTRA_DETAILS;
        ...
        assertThat(testPersonDTO.firstName).isEqualTo(UPDATED_FIRST_NAME);
        assertThat(testPersonDTO.lastName).isEqualTo(UPDATED_LAST_NAME);
        ...
        assertThat(testPersonDTO.extraDetails).isEqualTo(UPDATED_EXTRA_DETAILS);
