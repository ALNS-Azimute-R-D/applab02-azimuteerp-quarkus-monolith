...
public class ArticleResourceTest {
    ...
    public static ArticleDTO createEntity() {
        ...
        articleDTO.assetsCollectionUUID = DEFAULT_ASSETS_COLLECTION_UUID;
        articleDTO.isEnabled = DEFAULT_IS_ENABLED;
        return articleDTO;
    }
    ...
    public void createArticle() {
        ...
        assertThat(testArticleDTO.assetsCollectionUUID).isEqualTo(DEFAULT_ASSETS_COLLECTION_UUID);
        assertThat(testArticleDTO.isEnabled).isEqualTo(DEFAULT_IS_ENABLED);
    }
    ...
    public void updateArticle() {
        ...
        updatedArticleDTO.assetsCollectionUUID = UPDATED_ASSETS_COLLECTION_UUID;
        updatedArticleDTO.isEnabled = UPDATED_IS_ENABLED;
        ...
        assertThat(testArticleDTO.assetsCollectionUUID).isEqualTo(UPDATED_ASSETS_COLLECTION_UUID);
        assertThat(testArticleDTO.isEnabled).isEqualTo(UPDATED_IS_ENABLED);
    }
    ...
    public void getAllArticles() {
        ...
        given()
            ...
            .body("customDescription", hasItem(DEFAULT_CUSTOM_DESCRIPTION.toString()))
            .body("priceValue", hasItem(DEFAULT_PRICE_VALUE.floatValue()))
            .body("itemSize", hasItem(DEFAULT_ITEM_SIZE.toString()))
            .body("assetsCollectionUUID", hasItem(DEFAULT_ASSETS_COLLECTION_UUID))
            .body("isEnabled", hasItem(DEFAULT_IS_ENABLED.booleanValue()));
    }
    ...
    public void getArticle() {
        ...
        given()
            ...
            .body("customDescription", is(DEFAULT_CUSTOM_DESCRIPTION.toString()))
            .body("priceValue", comparesEqualTo(DEFAULT_PRICE_VALUE.floatValue()))
            .body("itemSize", is(DEFAULT_ITEM_SIZE.toString()))
            .body("assetsCollectionUUID", is(DEFAULT_ASSETS_COLLECTION_UUID))
            .body("isEnabled", is(DEFAULT_IS_ENABLED.booleanValue()));
    }
