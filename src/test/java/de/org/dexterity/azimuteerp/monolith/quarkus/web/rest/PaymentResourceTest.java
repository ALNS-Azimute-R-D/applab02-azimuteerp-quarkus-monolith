...
public class PaymentResourceTest {
    ...
    private static final PaymentStatusEnum DEFAULT_STATUS = PaymentStatusEnum.OPEN;
    private static final PaymentStatusEnum UPDATED_STATUS = PaymentStatusEnum.DELAYED;
    ...
    public static PaymentDTO createEntity() {
        ...
        paymentDTO.status = DEFAULT_STATUS;
        paymentDTO.extraDetails = DEFAULT_EXTRA_DETAILS;
        return paymentDTO;
    }
    ...
    public void createPayment() {
        ...
        assertThat(testPaymentDTO.status).isEqualTo(DEFAULT_STATUS);
        assertThat(testPaymentDTO.extraDetails).isEqualTo(DEFAULT_EXTRA_DETAILS);
    }
    ...
    public void updatePayment() {
        ...
        updatedPaymentDTO.status = UPDATED_STATUS;
        updatedPaymentDTO.extraDetails = UPDATED_EXTRA_DETAILS;
        ...
        assertThat(testPaymentDTO.status).isEqualTo(UPDATED_STATUS);
        assertThat(testPaymentDTO.extraDetails).isEqualTo(UPDATED_EXTRA_DETAILS);
    }
