...
public class AssetTypeResourceTest {
    ...
    public static AssetTypeDTO createEntity() {
        ...
        assetTypeDTO.extraDetails = DEFAULT_EXTRA_DETAILS;
        return assetTypeDTO;
    }
    ...
    public void createAssetType() {
        ...
        assertThat(testAssetTypeDTO.extraDetails).isEqualTo(DEFAULT_EXTRA_DETAILS);
    }
    ...
    public void updateAssetType() {
        ...
        updatedAssetTypeDTO.extraDetails = UPDATED_EXTRA_DETAILS;
        ...
        assertThat(testAssetTypeDTO.extraDetails).isEqualTo(UPDATED_EXTRA_DETAILS);
    }
