...
public class OrderResourceTest {
    ...
    public static OrderDTO createEntity() {
        ...
        orderDTO.customerUserId = DEFAULT_CUSTOMER_USER_ID;
        ...
        orderDTO.invoiceId = DEFAULT_INVOICE_ID;
    ...
    public void createOrder() {
        ...
        assertThat(testOrderDTO.customerUserId).isEqualTo(DEFAULT_CUSTOMER_USER_ID);
        ...
        assertThat(testOrderDTO.invoiceId).isEqualTo(DEFAULT_INVOICE_ID);
    ...
    @Test
    public void checkCustomerUserIdIsRequired() throws Exception {
        var databaseSizeBeforeTest = given()
            .auth()
            .preemptive()
            .oauth2(adminToken)
    ...
    public void updateOrder() {
        ...
        updatedOrderDTO.customerUserId = UPDATED_CUSTOMER_USER_ID;
        ...
        updatedOrderDTO.invoiceId = UPDATED_INVOICE_ID;
        ...
        assertThat(testOrderDTO.customerUserId).isEqualTo(UPDATED_CUSTOMER_USER_ID);
        ...
        assertThat(testOrderDTO.invoiceId).isEqualTo(UPDATED_INVOICE_ID);
    ...
    public void getAllOrders() {
        ...
        given()
            ...
            .body("customerUserId", hasItem(DEFAULT_CUSTOMER_USER_ID))
    ...
    public void getOrder() {
        ...
        given()
            ...
            .body("customerUserId", is(DEFAULT_CUSTOMER_USER_ID))
