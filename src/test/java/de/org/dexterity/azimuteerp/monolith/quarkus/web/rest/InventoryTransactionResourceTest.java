...
public class InventoryTransactionResourceTest {
    ...
    public static InventoryTransactionDTO createEntity() {
        ...
        inventoryTransactionDTO.comments = DEFAULT_COMMENTS;
    ...
    public void createInventoryTransaction() {
        ...
        assertThat(testInventoryTransactionDTO.comments).isEqualTo(DEFAULT_COMMENTS);
    }
    ...
    public void updateInventoryTransaction() {
        ...
        updatedInventoryTransactionDTO.comments = UPDATED_COMMENTS;
        ...
        assertThat(testInventoryTransactionDTO.comments).isEqualTo(UPDATED_COMMENTS);
    }
    ...
    public void getAllInventoryTransactions() {
        ...
        given()
            ...
            .body("comments", hasItem(DEFAULT_COMMENTS));
    }
