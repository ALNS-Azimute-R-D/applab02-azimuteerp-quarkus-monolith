...
public class RawAssetProcTmpResourceTest {
    ...
    public static RawAssetProcTmpDTO createEntity() {
        ...
        rawAssetProcTmpDTO.extraDetails = DEFAULT_EXTRA_DETAILS;
    ...
    public void createRawAssetProcTmp() {
        ...
        assertThat(testRawAssetProcTmpDTO.extraDetails).isEqualTo(DEFAULT_EXTRA_DETAILS);
    }
    ...
    public void updateRawAssetProcTmp() {
        ...
        updatedRawAssetProcTmpDTO.extraDetails = UPDATED_EXTRA_DETAILS;
        ...
        assertThat(testRawAssetProcTmpDTO.extraDetails).isEqualTo(UPDATED_EXTRA_DETAILS);
    }
