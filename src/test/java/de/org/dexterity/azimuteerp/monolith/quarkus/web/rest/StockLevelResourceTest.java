...
public class StockLevelResourceTest {
    ...
    private static final Integer DEFAULT_RAMAINING_QUANTITY = 1;
    private static final Integer UPDATED_RAMAINING_QUANTITY = 2;
    ...
    public static StockLevelDTO createEntity() {
        ...
        stockLevelDTO.ramainingQuantity = DEFAULT_RAMAINING_QUANTITY;
        stockLevelDTO.extraDetails = DEFAULT_EXTRA_DETAILS;
    ...
    public void createStockLevel() {
        ...
        assertThat(testStockLevelDTO.ramainingQuantity).isEqualTo(DEFAULT_RAMAINING_QUANTITY);
        assertThat(testStockLevelDTO.extraDetails).isEqualTo(DEFAULT_EXTRA_DETAILS);
    }
    ...
    @Test
    public void checkRamainingQuantityIsRequired() throws Exception {
        var databaseSizeBeforeTest = given()
            .auth()
            .preemptive()
            .oauth2(adminToken)
        ...
        // set the field null
        stockLevelDTO.ramainingQuantity = null;
    ...
    public void updateStockLevel() {
        ...
        updatedStockLevelDTO.ramainingQuantity = UPDATED_RAMAINING_QUANTITY;
        updatedStockLevelDTO.extraDetails = UPDATED_EXTRA_DETAILS;
        ...
        assertThat(testStockLevelDTO.ramainingQuantity).isEqualTo(UPDATED_RAMAINING_QUANTITY);
        assertThat(testStockLevelDTO.extraDetails).isEqualTo(UPDATED_EXTRA_DETAILS);
    }
    ...
    public void getAllStockLevels() {
        ...
        given()
            ...
            .body("ramainingQuantity", hasItem(DEFAULT_RAMAINING_QUANTITY.intValue()))
    ...
    public void getStockLevel() {
        ...
        given()
            ...
            .body("ramainingQuantity", is(DEFAULT_RAMAINING_QUANTITY.intValue()))
