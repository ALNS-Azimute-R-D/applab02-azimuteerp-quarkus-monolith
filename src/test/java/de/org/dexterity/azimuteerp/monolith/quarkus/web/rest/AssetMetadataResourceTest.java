...
public class AssetMetadataResourceTest {
    ...
    private static final String DEFAULT_METADATA_DETAILS = "AAAAAAAAAA";
    private static final String UPDATED_METADATA_DETAILS = "BBBBBBBBBB";
    ...
    public static AssetMetadataDTO createEntity() {
        ...
        assetMetadataDTO.metadataDetails = DEFAULT_METADATA_DETAILS;
    ...
    public void createAssetMetadata() {
        ...
        assertThat(testAssetMetadataDTO.metadataDetails).isEqualTo(DEFAULT_METADATA_DETAILS);
    }
    ...
    public void updateAssetMetadata() {
        ...
        updatedAssetMetadataDTO.metadataDetails = UPDATED_METADATA_DETAILS;
        ...
        assertThat(testAssetMetadataDTO.metadataDetails).isEqualTo(UPDATED_METADATA_DETAILS);
    }
    ...
    public void getAllAssetMetadata() {
        ...
        given()
            ...
            .body("metadataDetails", hasItem(DEFAULT_METADATA_DETAILS.toString()));
    }
    ...
    public void getAssetMetadata() {
        ...
        given()
            ...
            .body("metadataDetails", is(DEFAULT_METADATA_DETAILS.toString()));
    }
